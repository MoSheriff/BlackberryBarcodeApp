...
public class StoreManagementImpl_Stub implements main.java.owfg.facade.bb.StoreManagement.stub.StoreManagementImpl, javax.xml.rpc.Stub {
	...
	public main.java.owfg.facade.bb.StoreManagement.stub.Store[] getActiveStores() throws java.rmi.RemoteException {
		...
		main.java.owfg.facade.bb.StoreManagement.stub.Store[] result;
		...
		if (_returnObj == null) {
			...
			result = new main.java.owfg.facade.bb.StoreManagement.stub.Store[storeArraySize];
			for (int storeArrayIndex = 0; 
				...
				if (_returnObj[storeArrayIndex] == null) {
					...
					result[storeArrayIndex] = new main.java.owfg.facade.bb.StoreManagement.stub.Store();
					long a_long;
	...
	public main.java.owfg.facade.bb.StoreManagement.stub.Banner[] getBanners() throws java.rmi.RemoteException {
		// Copy the incoming values into an Object array if needed.
		Object[] inputObject = new Object[0];
		...
		main.java.owfg.facade.bb.StoreManagement.stub.Banner[] result;
		// Convert the result into the right Java type.
		// Unwrapped return value
		Object[] _returnObj = (Object[]) ((Object[])resultObj)[0];
		if (_returnObj == null) {
			...
			result = new main.java.owfg.facade.bb.StoreManagement.stub.Banner[bannerArraySize];
			for (int bannerArrayIndex = 0; 
				...
				if (_returnObj[bannerArrayIndex] == null) {
					...
					result[bannerArrayIndex] = new main.java.owfg.facade.bb.StoreManagement.stub.Banner();
					long a_long;
	...
	public main.java.owfg.facade.bb.StoreManagement.stub.StoreManagementInfo getStoreManagementInfo(long storeId, java.lang.String upc) throws java.rmi.RemoteException {
		// Copy the incoming values into an Object array if needed.
		...
		main.java.owfg.facade.bb.StoreManagement.stub.StoreManagementInfo result;
		// Convert the result into the right Java type.
		// Unwrapped return value
		Object[] _returnObj = (Object[]) ((Object[])resultObj)[0];
		if (_returnObj == null) {
			...
			result = new main.java.owfg.facade.bb.StoreManagement.stub.StoreManagementInfo();
